...
//Default is AP mode.
int wifiType = 0; // 0:Station  1:AP  wifiType = 1;
...
const char* ssid = "WIFI NAME"; // Put your SSID here
const char* password = "WIFI PASSWD"; // Put your PASSWORD here
...
void serverStream(){
  ...
  while (1){
    ...
    static const size_t bufferSize = 4096;  //4096 best
    static uint8_t buffer[bufferSize] = {0xFF};
...
void setup() {
  ...
  myCAM.set_format(JPEG);
   ...
   //myCAM.OV5642_set_JPEG_size(OV5642_320x240);        // 0.4초마다
   myCAM.OV5642_set_JPEG_size(OV5642_1024x768);       // 1.4초마다
   //myCAM.OV5642_set_JPEG_size(OV5642_2592x1944);    // 8초마다
   //delay(1000);
  if (wifiType == 0){
    if(!strcmp(ssid,"SSID")){
